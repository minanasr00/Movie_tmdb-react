...
<nav className="bg-white border-gray-200 dark:bg-[#000000cc] mt-5 z-50 border-2 dark:border-blue-600 rounded-4xl max-w-screen-xl mx-auto fixed top-0 right-0 left-0">
  <div className="max-w-screen-xl  flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div ref={ulDivRef} className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-[#00000024]">
        <li>
